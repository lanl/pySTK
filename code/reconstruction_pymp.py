...
def reeber2_calculation(full_recon_data,reeber_folder,recontype):
    ...
    cmd = 'cd '+hdf5path+';'+'cp NVB_C009_l10n512_S12345T692_z'+hdf5_file_num+'.hdf5 NVB_C009_l10n512_S12345T692_z'+hdf5_file_num+'_mod.hdf5'
    os.system(cmd)
    ...
    outputCSVname = reeber_folder+'/'+'_integral_128_'+str(sampling_rate)+'_'+sampling_method+'_'+str(recontype)
    ...
    cmd = '~/work/halo_finder/hdf5_halo/reeber/build/examples/amr-connected-components/amr_connected_components_float -b 128 -n -w -f native_fields/baryon_density '+ infile + ' none none '+outputCSVname
    os.system(cmd)
